...
exports.productsRouter.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, products_model_1.getProducts)()];
            case 1:
                products = _a.sent();
                res.render("products", {
                    items: products,
...
exports.productsRouter.get('/search', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, products_model_1.searchProducts)(req.query)];
            case 1:
                products = _a.sent();
                res.render("products", {
                    items: products,
...
exports.productsRouter.get('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, products_model_1.getProduct)(req.params.id)];
            case 1:
                product = _a.sent();
                if (product) {
